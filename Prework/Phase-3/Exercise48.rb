# Question 1
# Take the hash found here and write code that outputs the following pieces of data:
#   1. the wind chill
#   2. the longitude
#   3. the current temperature
#   4. the high for next Sunday
...
# Question 2
# Take the hash found here and write code that outputs the "needle".
